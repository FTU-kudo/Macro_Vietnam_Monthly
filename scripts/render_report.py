...
def render_special_insight_html(topic_key: str, insight_data: dict) -> str:
    ...
    FALLBACK_CONFIGS = {
        ...
        "retail": {
            ...
            "summary": "Bán lẻ &amp; dịch vụ tiêu dùng 6 tháng +12.9% YoY, đạt ~3.89 triệu tỷ đồng — động lực nội địa mạnh trong bối cảnh ngoại thương nhập siêu.",
            "numbers": 'Bán lẻ + dịch vụ 6 tháng đạt <span class="num">~3.89 triệu tỷ đồng</span> (<span class="num">+12.9%</span> YoY) — duy trì đà tăng trưởng tích cực theo MAS Research. Đáng chú ý: tăng trưởng loại trừ yếu tố giá đạt <span class="num">+7.3%</span> YoY (theo TVS) — khoảng cách <span class="num">5.6 điểm phần trăm</span> cho thấy <strong>tăng trưởng chịu tác động của yếu tố giá nhưng khối lượng tiêu dùng thực vẫn vững vàng</strong>, lạm phát có ảnh hưởng hơn so với cùng kỳ. Khách quốc tế 6 tháng đạt <span class="num">12.3 triệu lượt</span> (<span class="num">+14.9%</span>) — mức cao kỷ lục — động lực trực tiếp cho dịch vụ lưu trú, ăn uống.',
            "cross": 'Khách quốc tế 6 tháng đạt <span class="num">12.3 triệu lượt</span> (<span class="num">+14.9%</span> YoY) — mức cao kỷ lục — trực tiếp thúc đẩy dịch vụ lưu trú và ăn uống tăng theo. Tăng trưởng bán lẻ danh nghĩa đạt <span class="num">+12.9%</span> YoY, trong khi mức tăng thực tế (trừ yếu tố giá) đạt <span class="num">+7.3%</span> YoY — cho thấy cầu tiêu dùng thực của người dân được duy trì ổn định trong môi trường lạm phát YTD 4.38%. Trong bối cảnh ngoại thương nhập siêu 16.65 tỷ USD, tiêu dùng nội địa đóng vai trò là trụ cột quan trọng giữ vững nhịp độ tăng trưởng vĩ mô chung.',
            "news": [
                {"title": "Tổng mức bán lẻ 6 tháng đạt ~3,89 triệu tỷ đồng", "url": "https://vietstock.vn/2026/06/tong-muc-ban-le-hang-hoa-va-doanh-thu-dich-vu-tieu-dung-trong-5-thang-dau-nam-dathon-318-trieu-ty-dong-768-1450043.htm", "source": "Vietstock · 06/2026", "sentiment": "TÍCH CỰC", "insight": "Số liệu từ Cục Thống kê — tăng 12.9% YoY lũy kế 6 tháng, tiêu dùng dịch vụ tiếp tục đóng vai trò dẫn dắt."},
                {"title": "Báo cáo vĩ mô nửa đầu năm 2026 — TVS Research", "url": "https://www.tvs.vn/api/files/10062026_Bao_cao_cap_nhat_Vi_mo_thang_5.pdf", "source": "TVS · 06/2026", "sentiment": "TRUNG TÍNH", "insight": "Tăng trưởng thực (loại trừ yếu tố giá) đạt 7.3% — mức tăng tiêu dùng thực chất vững vàng."},
